...
jQuery(document).ready(function($){
	...
	/************** LightBox *********************/
	$(function(){
		$('[data-rel="lightbox"]').on('click',function(e){
			e.preventDefault();
			$('#lightbox_block').find('a').remove();
			$('#lightbox_block').append($(this).next('.rooms').html());
			$('#lightbox_block').find('a').lightbox();
			$('#lightbox_block > a:nth-child(1)').trigger('click')
		})
	});
